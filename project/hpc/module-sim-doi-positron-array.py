...
source_radius = 18 * u.mm
source_distance = 25 * u.cm
source_center = [0, 0, -source_distance]
cone_margin = 1.00
#theta_max = cone_margin * math.atan((block_xy / 2.0 + source_radius) / source_distance) #most 'correct' but inefficient - most gammas miss!
theta_max = cone_margin * math.atan((block_xy / 4.0) / source_distance) 
